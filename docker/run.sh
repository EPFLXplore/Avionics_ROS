...
docker run -it \
    ...
    "$IMAGE_NAME" \
    -c "sudo chown -R $USERNAME:$USERNAME /home/$USERNAME; cd /home/$USERNAME; source /uros_ws/install/local_setup.bash; source dev_ws/install/setup.bash; ${*:-exec /bin/bash}"
